<div class="container">
    <div class="card" style="max-width: 800px; margin: 2rem auto; padding: 2rem;">
        <div style="margin-bottom: 2rem; border-bottom: 1px solid var(--border); padding-bottom: 1rem;">
            ...
            <p class="text-muted" style="margin-top: 0.5rem;">Définissez les détails de votre projet pour trouver le développeur idéal.</p>
        </div>
        ...
        <form action="/projects/store" method="POST">
            <div class="form-group">
                ...
                <input type="text" name="title" id="title" class="form-control" placeholder="Ex: Refonte site e-commerce" required>
            </div>
            ...
            <div class="form-group">
                ...
                <textarea name="description" id="description" class="form-control" rows="6" placeholder="Décrivez les objectifs, les livrables attendus et le contexte du projet..." required></textarea>
            </div>

            <div class="form-group">
                <label for="keywords" style="font-weight: 600;">Mots-clés</label>
                <input type="text" name="keywords" id="keywords" class="form-control" placeholder="Ex: React, PHP, Urgent, E-commerce (séparés par des virgules)">
                ...
                <div class="skills-grid" style="display: flex; flex-wrap: wrap; gap: 0.75rem; background: var(--bg-secondary); padding: 1.5rem; border-radius: var(--radius);">
                    <?php foreach ($skills as $skill): ?>
                        <label class="skill-checkbox" style="display: flex; align-items: center; gap: 0.5rem; cursor: pointer; background: var(--bg-primary); padding: 0.5rem 1rem; border-radius: 20px; border: 1px solid var(--border); transition: all 0.2s;">
                            <input type="checkbox" name="skills[]" value="<?= $skill['id'] ?>" style="accent-color: var(--primary);">
